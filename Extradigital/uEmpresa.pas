...
type
  TfrmEmpresa = class(TForm)
    ...
    pnEmp: TPanel;
    pnEnd: TPanel;
    pgEmpresa: TPageControl;
    tbsRegiao: TTabSheet;
    grdEmpresa: TDBGrid;
    pnBotoesEmp: TPanel;
    SpeedButtonInsertEmp: TcxButton;
    SpeedButtonDeleteEmp: TcxButton;
    SpeedButtonEditEmp: TcxButton;
    SpeedButtonPostEmp: TcxButton;
    SpeedButtonCancelEmp: TcxButton;
    pnManutencao: TPanel;
    lbEmpresa: TLabel;
    lbCNPJ: TLabel;
    edEmpresa: TEdit;
...
procedure TfrmEmpresa.LimpaTela;
var i:Integer;
begin
...
procedure TfrmEmpresa.SpeedButtonCancelEmpClick(Sender: TObject);
begin
  LimpaTela;
  Opr:='';
  AjustaBotoesEmp;
...
procedure TfrmEmpresa.SpeedButtonCancelEndClick(Sender: TObject);
begin
  LimpaTela;
  OprEnd:='';
  AjustaBotoesEnd;
...
procedure TfrmEmpresa.SpeedButtonDeleteEmpClick(Sender: TObject);
begin
...
procedure TfrmEmpresa.SpeedButtonDeleteEndClick(Sender: TObject);
...
procedure TfrmEmpresa.SpeedButtonEditEmpClick(Sender: TObject);
begin
  if not qryEmpresa.IsEmpty then begin
    Opr:='E';
    AjustaBotoesEmp;
...
procedure TfrmEmpresa.SpeedButtonEditEndClick(Sender: TObject);
begin
  if not qryEndereco.IsEmpty then begin
    OprEnd:='E';
    AjustaBotoesEnd;
...
procedure TfrmEmpresa.SpeedButtonInsertEmpClick(Sender: TObject);
begin
  pgEmpresa.ActivePageIndex := 1;
  LimpaTela;
  Opr:='I';
...
procedure TfrmEmpresa.SpeedButtonInsertEndClick(Sender: TObject);
begin
  pgEndereco.ActivePageIndex := 1;
  LimpaTela;
  OprEnd:='I';
...
procedure TfrmEmpresa.SpeedButtonPostEmpClick(Sender: TObject);
...
procedure TfrmEmpresa.SpeedButtonPostEndClick(Sender: TObject);
...
procedure TfrmEmpresa.AbreTabelas;
begin
  qryEmpresa.Close;
  qryEmpresa.Open;
  qryEndereco.Close;
...
procedure TfrmEmpresa.AjustaBotoesEmp;
begin
  if (Opr = 'I') then begin
...
procedure TfrmEmpresa.AjustaBotoesEnd;
begin
...
procedure TfrmEmpresa.AtribuiValoresEmp;
begin
...
procedure TfrmEmpresa.AtribuiValoresEnd;
begin
...
procedure TfrmEmpresa.CarregaCidade;
begin
  qryAux.Close;
...
procedure TfrmEmpresa.CarregaUF;
begin
  qryAux.Close;
...
procedure TfrmEmpresa.grdEmpresaDblClick(Sender: TObject);
begin
  if not qryEmpresa.IsEmpty then begin
    Opr:='C';
    AjustaBotoesEmp;
...
procedure TfrmEmpresa.grdEnderecoDblClick(Sender: TObject);
begin
  if not qryEndereco.IsEmpty then begin
    OprEnd:='C';
    AjustaBotoesEnd;
